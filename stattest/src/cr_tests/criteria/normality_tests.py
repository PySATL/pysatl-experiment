...
from stattest.src.cr_tests.criteria.goodness_test import GoodnessOfFitTest
from stattest.src.core.distribution import norm
import numpy as np
import scipy.stats as scipy_stats
import pandas as pd

from stattest.src.cr_tests.caches.cache import MonteCarloCacheService
...
"""""
class ChiSquareTest(NormalityTest):
...
"""
class ZhangQQStarTest(NormalityTest):

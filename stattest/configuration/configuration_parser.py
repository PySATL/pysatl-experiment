...
class ConfigurationParser:
    @staticmethod
    def _parse_json_class_list(resolver: IResolver, json_dicts_list: list[dict]) -> list[IParsable]:
        class_list = list()
    ...
    @staticmethod
    def _parse_json_class(resolver: IResolver, json_dict: dict) -> IParsable:

...
if __name__ == '__main__':
    ...
    alternatives_configuration = AlternativeConfiguration(symmetric_generators, sizes, count=1_000,
                                                          threads=3,
                                                          listeners=listeners)
    ...
    power_calculation_worker = PowerCalculationWorker(0.05, 1_000_000, power_result_store,

...
<<<<<<<< HEAD:stattest_std/tests/normality/hosking3_t.py
from stattest_std.src.stat_tests.normality_tests import Hosking3Test
...
>>>>>>>> architecture:tests/normality/hosking3_t.py

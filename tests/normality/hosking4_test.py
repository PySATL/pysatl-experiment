...
<<<<<<<< HEAD:stattest_std/tests/normality/hosking4_test.py
from stattest_std.src.stat_tests.normality_tests import Hosking4Test
...
>>>>>>>> architecture:tests/normality/hosking4_test.py

...
<<<<<<<< HEAD:stattest_std/tests/normality/hosking1_test.py
from stattest_std.src.stat_tests.normality_tests import Hosking1Test
...
>>>>>>>> architecture:tests/normality/hosking1_test.py

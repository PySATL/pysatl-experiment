...
<<<<<<<< HEAD:stattest_std/tests/normality/cabana_cabana2_test.py
from stattest_std.src.stat_tests.normality_tests import CabanaCabana2Test
...
>>>>>>>> architecture:tests/normality/cabana_cabana2_test.py

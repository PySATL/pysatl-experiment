...
<<<<<<<< HEAD:stattest_std/tests/normality/doornik_hasen_test.py
from stattest_std.src.stat_tests.normality_tests import DoornikHansenTest
...
>>>>>>>> architecture:tests/normality/doornik_hasen_test.py

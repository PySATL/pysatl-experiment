...
<<<<<<<< HEAD:stattest_std/tests/normality/zhang_qstar_test.py
from stattest_std.src.stat_tests.normality_tests import ZhangQStarTest
...
>>>>>>>> architecture:tests/normality/zhang_qstar_test.py

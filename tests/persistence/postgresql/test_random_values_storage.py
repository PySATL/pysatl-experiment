...
from pysatl_experiment.persistence.storage.random_values.postgresql.postgresql import PostgreSQLRandomValuesStorage
...
def storage(temp_postgres_db):
    return PostgreSQLRandomValuesStorage(temp_postgres_db, "test_random_values")
...
class TestPostgreSQLRandomValuesStorage:

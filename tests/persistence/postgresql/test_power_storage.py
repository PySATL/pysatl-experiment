...
from pysatl_experiment.persistence.storage.power.postgresql.postgresql import PostgreSQLPowerStorage


# TODO: clearance


# Temporary PostgreSQL database fixture
...
def storage(temp_postgres_db):
    storage = PostgreSQLPowerStorage(temp_postgres_db, "test_power_analysis")
    storage.init()
    return storage
...
class TestPostgreSQLPowerStorage:
...
class TestErrorHandling:
    ...
    def test_connection_error_on_init(self, mock_connect):
        ...
        storage = PostgreSQLPowerStorage("invalid_connection_string")

...
class TestPostgreSQLExperimentStorage:
    @pytest.fixture
    def storage(self):
        return PostgreSQLExperimentStorage(connection_string="postgresql://test:test@localhost/test")
...
class TestPostgreSQLExperimentStorageIntegration:
    @pytest.fixture
    def integration_storage(self):
        # Should use real DB
        storage = PostgreSQLExperimentStorage(connection_string="postgresql://test:test@localhost/test_db")

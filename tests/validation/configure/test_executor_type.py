...
@patch("pysatl_experiment.cli.commands.configure.executor_type.executor_type.get_experiment_name_and_config")
@patch("pysatl_experiment.cli.commands.configure.executor_type.executor_type.save_experiment_config")
def test_executor_type_with_invalid_type(
    ...
    result = runner.invoke(executor_type, [invalid_type])
...
def test_executor_type_with_unsupported_custom_type(
    ...
    result = runner.invoke(executor_type, [custom_type])
...
def test_executor_type_with_valid_supported_type(
    ...
    result = runner.invoke(executor_type, [valid_type.value])
    ...
    expected_output = f"Executor type of the experiment '{experiment_name}' is set to '{valid_type.value}'.\n"
